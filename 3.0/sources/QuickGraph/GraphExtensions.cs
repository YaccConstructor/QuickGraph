...
namespace QuickGraph
{
    namespace ArrayExtensions
    {
        ...
        {
            // TODO: a better name for ToString2?
            public static string ToString2<T>(this T[] array)
            {
            ...
            public static bool ArrayEquals(this float[] lhs, float[] rhs, float tolerance)
            {
            ...
            public static bool ArrayEquals(this double[] lhs, double[] rhs, double tolerance)
            {
                if (ReferenceEquals(lhs, null))
                {
                    return ReferenceEquals(rhs, null);
