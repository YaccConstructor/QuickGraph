...
namespace PrimVisualisation
{
    ...
    public class PrimVisualisation : IAlgorithm
    {
        ...
        public void Run(string dotSource)
        {
            ...
            var prim = new QuickGraph.Algorithms.MinimumSpanningTree.PrimMinimumSpanningTreeAlgorithm<GraphXVertex, GraphXTaggedEdge<GraphXVertex, int>>(grap, x => x.Tag);
            prim.TreeEdge += Kruskal_TreeEdge;
            prim.ExamineEdge += Kruskal_ExamineEdge;
            prim.Compute();
