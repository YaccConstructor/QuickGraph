...
namespace QuickGraph.Algorithms.ShortestPath.Yen
{
  public class YenShortestPathsAlgorithm<TVertex>
  {
    ...
    private int k;
    private IMutableVertexAndEdgeListGraph<TVertex, TaggedEquatableEdge<TVertex, double>> _graph;
    ...
    */
    ...
    public YenShortestPathsAlgorithm(IMutableVertexAndEdgeListGraph<TVertex, TaggedEquatableEdge<TVertex, double>> graph, TVertex s,
      TVertex t, int k)
    {
      _sourceVertix = s;
      _targetVertix = t;
    ...
    private IEnumerable<TaggedEquatableEdge<TVertex, double>> GetShortestPathInGraph(
      IMutableVertexAndEdgeListGraph<TVertex, TaggedEquatableEdge<TVertex, double>> graph)
    {
