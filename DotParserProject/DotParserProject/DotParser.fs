...
let numToString = function
    ...
    | 13 -> "stmt_list"
    | 14 -> "subgraph"
    | 15 -> "yard_exp_brackets_78"
    | 16 -> "yard_exp_brackets_79"
    | 17 -> "yard_exp_brackets_80"
    | 18 -> "yard_exp_brackets_81"
    | 19 -> "yard_exp_brackets_82"
    | 20 -> "yard_exp_brackets_83"
    | 21 -> "yard_exp_brackets_84"
    | 22 -> "yard_exp_brackets_85"
    | 23 -> "yard_exp_brackets_86"
    | 24 -> "yard_exp_brackets_87"
    | 25 -> "yard_many_21"
    | 26 -> "yard_many_22"
    | 27 -> "yard_many_23"
    | 28 -> "yard_many_24"
    ...
    | 35 -> "yard_rule_74"
    | 36 -> "yard_rule_76"
    | 37 -> "yard_rule_list_75"
    | 38 -> "yard_rule_list_77"
    | 39 -> "yard_start_rule"
    | 40 -> "ASSIGN"
    | 41 -> "COL"
    | 42 -> "COMMA"
...
let _rnglr_extra_array, _rnglr_rule_, _rnglr_concats = 
  (Array.zeroCreate 0 : array<'_rnglr_type_a_list * '_rnglr_type_attr_list * '_rnglr_type_attr_stmt * '_rnglr_type_compass_pt * '_rnglr_type_edge_operator * '_rnglr_type_edge_stmt * '_rnglr_type_error * '_rnglr_type_full_stmt * '_rnglr_type_graph * '_rnglr_type_id * '_rnglr_type_node_id * '_rnglr_type_node_stmt * '_rnglr_type_port * '_rnglr_type_stmt_list * '_rnglr_type_subgraph * '_rnglr_type_yard_exp_brackets_78 * '_rnglr_type_yard_exp_brackets_79 * '_rnglr_type_yard_exp_brackets_80 * '_rnglr_type_yard_exp_brackets_81 * '_rnglr_type_yard_exp_brackets_82 * '_rnglr_type_yard_exp_brackets_83 * '_rnglr_type_yard_exp_brackets_84 * '_rnglr_type_yard_exp_brackets_85 * '_rnglr_type_yard_exp_brackets_86 * '_rnglr_type_yard_exp_brackets_87 * '_rnglr_type_yard_many_21 * '_rnglr_type_yard_many_22 * '_rnglr_type_yard_many_23 * '_rnglr_type_yard_many_24 * '_rnglr_type_yard_opt_31 * '_rnglr_type_yard_opt_32 * '_rnglr_type_yard_opt_33 * '_rnglr_type_yard_opt_34 * '_rnglr_type_yard_opt_35 * '_rnglr_type_yard_opt_36 * '_rnglr_type_yard_rule_74 * '_rnglr_type_yard_rule_76 * '_rnglr_type_yard_rule_list_75 * '_rnglr_type_yard_rule_list_77 * '_rnglr_type_yard_start_rule>), 
  [|
  (
            ...
            (match ((unbox _rnglr_children.[0]) : Token) with COL _rnglr_val -> [_rnglr_val] | a -> failwith "COL expected, but %A found" a )
             |> List.iter (fun (_) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_id) 
               |> List.iter (fun (_) -> 
                ((unbox _rnglr_children.[2]) : '_rnglr_type_yard_opt_34) 
                 |> List.iter (fun (_) -> 
                  _rnglr_cycle_res := (
        ...
        ( fun hd ->
          (
            ...
            ((unbox _rnglr_children.[0]) : '_rnglr_type_edge_operator) 
             |> List.iter (fun (_) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_rule_76) 
               |> List.iter (fun (i) -> 
                _rnglr_cycle_res := (
        ...
        ( fun hd ->
          (
            ...
            (match ((unbox _rnglr_children.[0]) : Token) with COMMA _rnglr_val -> [_rnglr_val] | a -> failwith "COMMA expected, but %A found" a )
             |> List.iter (fun (_) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_rule_74) 
               |> List.iter (fun (i) -> 
                _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_87) 
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_opt_35) 
             |> List.iter (fun (_) -> 
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_85) 
             |> List.iter (fun (_) -> 
              _rnglr_cycle_res := (
          ...
          (
            ...
            ((unbox _rnglr_children.[0]) : '_rnglr_type_id) 
             |> List.iter (fun (nodeID) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_opt_33) nodeID
               |> List.iter (fun (_) -> 
                _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( fun hd ->
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_84) hd
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_rule_76) 
             |> List.iter (fun (hd) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_many_24) hd
               |> List.iter (fun (tl) -> 
                _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( fun hd ->
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_83) hd
             |> List.iter (fun (yard_head) -> 
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_rule_74) 
             |> List.iter (fun (hd) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_many_23) hd
               |> List.iter (fun (tl) -> 
                _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_rule_list_75) 
             |> List.iter (fun (lst) -> 
              _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_82) 
             |> List.iter (fun (yard_head) -> 
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_80) 
             |> List.iter (fun (yard_head) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_many_21) 
               |> List.iter (fun (yard_tail) -> 
                _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_many_21) 
             |> List.iter (fun (lst) -> 
              _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_exp_brackets_79) 
             |> List.iter (fun (yard_elem) -> 
              _rnglr_cycle_res := (
    ...
    fun (_rnglr_children : array<_>) (parserRange : (uint64 * uint64)) -> 
      box (
        ( 
          (
            let _rnglr_cycle_res = ref []
            ((unbox _rnglr_children.[0]) : '_rnglr_type_yard_opt_31) 
             |> List.iter (fun (_) -> 
              ((unbox _rnglr_children.[1]) : '_rnglr_type_yard_exp_brackets_78) 
               |> List.iter (fun (_) -> 
                ((unbox _rnglr_children.[2]) : '_rnglr_type_yard_opt_32) 
                 |> List.iter (fun (_) -> 
...
# 1445 "DotParser.fs"
  ...
  |] , [|
    ...
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_exp_brackets_78)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_exp_brackets_79)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
    ...
    (fun (_rnglr_list : list<_>) -> 
      box ( fun hd ->
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_exp_brackets_83)  hd ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( fun hd ->
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_exp_brackets_84)  hd ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
    ...
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_many_21)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
    ...
    (fun (_rnglr_list : list<_>) -> 
      box ( fun nodeID ->
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_opt_33)  nodeID ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
    ...
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_rule_74)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_rule_76)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
        _rnglr_list |> List.map (fun _rnglr_item -> ((unbox _rnglr_item) : '_rnglr_type_yard_rule_list_75)   ) |> List.concat));
    (fun (_rnglr_list : list<_>) -> 
      box ( 
